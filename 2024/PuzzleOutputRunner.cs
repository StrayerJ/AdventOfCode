    ...
    public class PuzzleOutputRunner
    {
        ...
        private void RunPuzze(int DayNumber)
        {
            switch (DayNumber)
            {
                ...
                case 9:
                    //--------------------------DAY 09---------------------------------
                    Puzzle_Day_09 D9_Puzzle = new(InputHelper.GetInputFilePath("2024", "D9P1.txt"));
                    Console.WriteLine("AoC - Day 09 - Part 01");
                    Console.WriteLine(D9_Puzzle.Solve_Part01());
                    D9_Puzzle = new(InputHelper.GetInputFilePath("2024", "D9P1.txt"));
                    Console.WriteLine("AoC - Day 09 - Part 02");
                    Console.WriteLine(D9_Puzzle.Solve_Part02());
                    break;
                case 10:
                    //--------------------------DAY 10---------------------------------
                    Puzzle_Day_10 D10_Puzzle = new(InputHelper.GetInputFilePath("2024", "D10P1.txt"));
                    Console.WriteLine("AoC - Day 10 - Part 01");
                    Console.WriteLine(D10_Puzzle.Solve_Part01());
                    Console.WriteLine("AoC - Day 10 - Part 02");
                    Console.WriteLine(D10_Puzzle.Solve_Part02());
                    break;
                case 11:
                    //--------------------------DAY 11---------------------------------
                    Puzzle_Day_11 D11_Puzzle = new(InputHelper.GetInputFilePath("2024", "D11P1.txt"));
                    Console.WriteLine("AoC - Day 11 - Part 01");
                    Console.WriteLine(D11_Puzzle.Solve_Part01());
                    Console.WriteLine("AoC - Day 11 - Part 02");
                    Console.WriteLine(D11_Puzzle.Solve_Part02());
                    break;
                default:
